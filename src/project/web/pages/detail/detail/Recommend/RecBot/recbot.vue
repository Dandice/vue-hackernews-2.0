<template>
    <div class="rec_bot">
        <div id="rec_bot_read" v-show="recommend[9]">
                ...
                <div class="bot_read_con_scroll">
                    <div class="bot_read_con" ref="botReadCon">
                        <a class="read_item"
                           ...
                           data-bn-ipg="bbs-thread-relapost-1"
                           v-for="i in 9" v-if="recommend[i+8]">
                            <div class="img"><img
                                :src="recommend[i+8].cover ? recommend[i+8].cover + '/210x140' : '//static.qyer.com/images/place/no/poi_200_133.png'">
                            </div>
                            <div class="des">
        ...
        <div id="rec_bot_ask" v-show="askArray.length">
...
<script>
    ...
    export default {
        data() {
            ...
            if (args.sync) {
                if (jsENV == 'node') {
                    delete this.$store.state.renderData.data.ask
                    //delete this.$store.state.renderData.data.recommend_threads
                } else {
                    askHtml = document.getElementById('rec_bot_ask').innerHTML;
                }
            }*/
            return {
                args,
        ...
        mounted() {
            ...
            if (!this.args.sync) {
                ...
                const {recommend_threads} = this.$store.state.renderData.data;
                this.$store.commit('SET_VALUE', {
                    page: 'recommend',
                    data: recommend_threads
                })
