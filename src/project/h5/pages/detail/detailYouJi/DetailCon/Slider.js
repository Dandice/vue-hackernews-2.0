...
class ChildSLI {
    ...
    touchEnd() {
        ...
        if (this.distX > 0 && this.cliIndex === 0) {
            ...
            this.to(-this.nIndex * this.screenW, 0, 300)
        } else if (duration < 300) {
            if (Math.abs(this.distX) > parseInt(this.screenW / 10)) {
            ...
            if (Math.abs(this.distX) > parseInt(this.screenW / 2)) {
                this.nIndex = this.distX > 0 ? this.nIndex - 1 : this.nIndex + 1
                this.cliIndex = this.distX > 0 ? this.cliIndex - 1 : this.cliIndex + 1
                this.to(-this.nIndex * this.screenW, 0, 300)
            } else {
...
class IScroll {
    ...
    changeState(newState) {
        ...
        this._state.to(-newState.nIndex * newState.screenW, 0, 0)
    }
